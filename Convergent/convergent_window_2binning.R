...
two_bin %>%
  ...
  select(data,type,analysis,Taxa1,Taxa2,comparison=comparison_merge,variable=Variable,window_name,window5=Window,Emp_p) -> two_binn
fwrite(two_binn,"/moonriseNFS/Null_W_Result/files/convergent_2binning",sep = "\t")